        ...
        prev.map((contest) => ({
          ...
          metrics: {
            views: {
              ...
              current:
                contest.metrics.views.current + Math.floor(Math.random() * 50),
            },
            likes: {
              ...contest.metrics.likes,
              current:
                contest.metrics.likes.current + Math.floor(Math.random() * 5),
            },
            comments: {
              ...contest.metrics.comments,
              current:
                contest.metrics.comments.current +
                Math.floor(Math.random() * 2),
            },
            shares: {
              ...contest.metrics.shares,
              current:
                contest.metrics.shares.current + Math.floor(Math.random() * 2),
            },
          },
  ...
  return (
    <div className="space-y-6">
        ...
        <CardHeader>
          <div className="flex items-center justify-between">
            <div>
              ...
              <CardDescription>
                Real-time monitoring of your contest performance
              </CardDescription>
            </div>
            <div className="flex items-center gap-3">
              <div className="flex items-center gap-2">
                <div
                  className={`w-2 h-2 rounded-full ${isTracking ? "bg-primary animate-pulse" : "bg-muted"}`}
                />
              ...
              >
                <RefreshCw
                  className={`mr-2 h-4 w-4 ${isTracking ? "animate-spin" : ""}`}
                />
      ...
      {contests.map((contest) => (
        <Card
          key={contest.id}
          className="border-2 border-border shadow-[4px_4px_0px_0px_rgba(0,0,0,0.1)]"
        >
          <CardHeader>
            <div className="flex items-center justify-between">
              <div>
          ...
          <CardContent className="space-y-6">
            ...
            <div className="space-y-2">
              ...
              <Progress
                value={(contest.score / contest.maxScore) * 100}
                className="h-3"
              />
            </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-4 gap-4">
              <MetricCard
                icon={Eye}
                label="Views"
                data={contest.metrics.views}
                color="text-primary"
              />
              <MetricCard
                icon={Heart}
                label="Likes"
                data={contest.metrics.likes}
                color="text-destructive"
              />
              <MetricCard
                icon={MessageCircle}
                label="Comments"
                data={contest.metrics.comments}
                color="text-accent"
              />
              <MetricCard
                icon={Share2}
                label="Shares"
                data={contest.metrics.shares}
                color="text-primary"
              />
            </div>
          ...
          <Tabs defaultValue="overview" className="space-y-4">
            ...
            <TabsContent value="trends">
              <Alert className="border-2 border-accent bg-accent/10">
                ...
                <AlertDescription>
                  Your performance has improved by 15% over the last week. Views
                  are trending upward, especially during evening hours.
                </AlertDescription>
              </Alert>
            </TabsContent>
            ...
            <TabsContent value="comparison">
              <Alert className="border-2 border-primary bg-primary/10">
                ...
                <AlertDescription>
                  You're performing 23% better than the average participant.
                  Your engagement rate is particularly strong on gaming content.
                </AlertDescription>
              </Alert>
            </TabsContent>
            ...
            <TabsContent value="insights">
              <div className="space-y-4">
                <Alert className="border-2 border-accent bg-accent/10">
                  ...
                  <AlertDescription>
                    <strong>Best posting time:</strong> Your clips perform 40%
                    better when posted between 7-9 PM EST.
                  </AlertDescription>
                </Alert>
                <Alert className="border-2 border-primary bg-primary/10">
                  <Target className="h-4 w-4" />
                  <AlertDescription>
                    <strong>Content tip:</strong> Gaming highlights with
                    commentary get 2x more engagement than silent clips.
                  </AlertDescription>
                </Alert>
              </div>
            </TabsContent>
