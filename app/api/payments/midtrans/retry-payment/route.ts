...
export async function POST(request: NextRequest) {
  try {
    ...
    console.log("Retry payment requested for contest:", contestId, "by user:", user.id);
    ...
    if (contest.status !== "pending_payment" && contest.payment_status !== "pending" && contest.payment_status !== "failed") {
      console.log("Contest not eligible for retry. Status:", contest.status, "Payment status:", contest.payment_status);
      return NextResponse.json(
