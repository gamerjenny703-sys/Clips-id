...
export async function GET(request: NextRequest) {
  ...
  try {
    ...
    return NextResponse.redirect(new URL("/user/dashboard?connected=twitter", request.url))
  } catch (error) {
...
export async function POST(request: NextRequest) {
  try {
    ...
    authUrl.searchParams.set("redirect_uri", `${process.env.NEXT_PUBLIC_APP_URL}/api/auth/twitter`)
